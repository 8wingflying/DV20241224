...
- Seaborn
  ...
  - Colab 已有支援
- Bokeh
- 互動式資料視覺化 interactive data visualizations :Plotly
...
### 範例
- [intro_to_plotting_with_bokeh.ipynb](https://colab.research.google.com/github/bebi103a/bebi103a.github.io/blob/master/lessons/06/intro_to_plotting_with_bokeh.ipynb#scrollTo=E61BNZyXoBDF)

### 參考資料
- [Bokeh documentation](https://docs.bokeh.org/en/latest/index.html)
- [Fundamentals of Data Visualization, in Bokeh ](https://github.com/bokeh/dataviz-fundamentals/)
# 4.互動式資料視覺化 interactive data visualizations :Plotly
  - [Plotly Open Source Graphing Library for Python](https://plotly.com/python/)
### 官方範例 1.[Time Series and Date Axes in Python](https://plotly.com/python/time-series/)
```python
